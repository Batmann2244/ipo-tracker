...
router.get("/api/admin/sync/test", requireAuth, async (req, res) => {
  try {
...
router.post("/api/admin/sync", requireAuth, async (req, res) => {
  try {
...
router.post("/api/admin/sync/clean", requireAuth, async (req, res) => {
  try {
...
router.get("/api/admin/scraper-logs", requireAuth, async (req, res) => {
  try {
...
router.get("/api/admin/scraper-logs/source/:source", requireAuth, async (req, res) => {
  try {
...
router.get("/api/admin/scraper-stats", requireAuth, async (req, res) => {
  try {
...
router.get("/api/admin/scraper-health", requireAuth, async (req, res) => {
  try {
...
router.post("/api/admin/sync-investorgain-ids", requireAuth, async (req, res) => {
  try {
